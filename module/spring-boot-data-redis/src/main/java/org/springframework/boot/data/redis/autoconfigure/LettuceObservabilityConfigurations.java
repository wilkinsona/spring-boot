...
class LettuceObservabilityConfigurations {
	...
	static class LettuceTracingConfiguration {

		@Bean
		ClientResourcesBuilderCustomizer lettuceTracing(ObservationRegistry observationRegistry) {
			return (client) -> client.tracing(new MicrometerTracing(null, null));
		}
