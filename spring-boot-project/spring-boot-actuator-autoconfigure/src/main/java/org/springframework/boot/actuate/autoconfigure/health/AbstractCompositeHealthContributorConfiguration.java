...
public abstract class AbstractCompositeHealthContributorConfiguration<C, I extends C, B> {
	 ...
	 * @since 3.4.3
	 */
	protected final C createContributor(ListableBeanFactory beanFactory, Class<B> beanType) {
		return createContributor(BeanFactoryUtils.beansOfTypeIncludingAncestors(beanFactory, beanType));
	}
