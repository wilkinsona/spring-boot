 ...
 * (deprecated)
 * <li>{@code management.endpoints.default-access} or
 * {@code management.endpoints.enabled-by-default} (deprecated)
 * </ol>
 * The resulting access is capped using {@code management.endpoints.max-permitted-access}.
 *
...
public class PropertiesEndpointAccessResolver implements EndpointAccessResolver {
	...
	public PropertiesEndpointAccessResolver(PropertyResolver properties) {
		...
		this.maxPermittedAccess = properties.getProperty("management.endpoints.max-permitted-access", Access.class,
				Access.UNRESTRICTED);
	}
