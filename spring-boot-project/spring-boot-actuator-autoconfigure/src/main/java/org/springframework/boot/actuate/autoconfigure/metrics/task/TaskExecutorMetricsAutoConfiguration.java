...
public class TaskExecutorMetricsAutoConfiguration {
	...
	@Autowired
	public void bindTaskExecutorsToRegistry(ListableBeanFactory beanFactory, MeterRegistry registry) {
		BeanFactoryUtils.beansOfTypeIncludingAncestors(beanFactory, TaskExecutor.class)
