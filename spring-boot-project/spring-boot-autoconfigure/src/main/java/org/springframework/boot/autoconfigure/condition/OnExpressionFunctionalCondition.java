...
class OnExpressionFunctionalCondition extends SpringBootFunctionalCondition {
	...
	public ConditionOutcome getMatchOutcome(ConditionContext context) {
		...
		if (beanFactory != null) {
			boolean result = evaluateExpression(beanFactory,
					context.getEnvironment().resolvePlaceholders(this.expression));
	 ...
	 */
	private static String wrapIfNecessary(String expression) {
